...
public class RemoveFoodMenuController {
    ...
    void enter_btn(ActionEvent event) {
        try {
            ...
            oos.writeObject(new RequestAndReply("REMOVE_FOOD_MENU_REQUEST", idDelete));
            ...
            alert.setContentText("Вы убрали продукт ID: : " + idDelete);
            alert.showAndWait();
